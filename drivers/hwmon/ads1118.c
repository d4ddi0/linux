...
#define ADS1118_NOP	0	/* validation pattern */
#define ADS1118_PULL_UP	3	/* pullup resistor on MISO */
#define ADS1118_TS_MODE	4	/* temperature sensor mode */
#define ADS1118_DR	5	/* data rate table index */
#define ADS1118_MODE	8	/* single shot mode */
#define ADS1118_PGA	9	/* programmmed gain */
#define ADS1118_MUX	12	/* input channel */
#define ADS1118_SS	15	/* start a conversion */
...
static void ads1118_get_cfg(struct ads1118 *ads)
{
#ifdef CONFIG_OF
	struct device_node *node;
